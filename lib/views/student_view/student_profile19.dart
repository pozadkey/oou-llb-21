...
import '../partial_views/student_details/student_details19.dart';

class StudentProfile19 extends StatefulWidget {
  const StudentProfile19({Key? key}) : super(key: key);

  @override
  _StudentProfile19State createState() => _StudentProfile19State();
}

class _StudentProfile19State extends State<StudentProfile19> {
      ...
      body: ListView(
        children: [
          ListView.builder(
              ...
              shrinkWrap: true,
              itemCount: studentList19.length,
              itemBuilder: (context, index) {
                Students19 students19 = studentList19[index];
                studentList19.sort((a, b) => a.name.compareTo(b.name));
                return Container(
                  height: 100,
                  child: Padding(
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => StudentDetails19(
