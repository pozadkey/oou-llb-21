...
import '../partial_views/student_details/student_details25.dart';
import 'student_profile24.dart';
import 'student_profile26.dart';

class StudentProfile25 extends StatefulWidget {
  const StudentProfile25({Key? key}) : super(key: key);

  @override
  _StudentProfile25State createState() => _StudentProfile25State();
}

class _StudentProfile25State extends State<StudentProfile25> {
      ...
      body: ListView(
        children: [
          ListView.builder(
              ...
              shrinkWrap: true,
              itemCount: studentList25.length,
              itemBuilder: (context, index) {
                Students25 students25 = studentList25[index];
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => StudentDetails25(
                                      students25: students25,
                                    )));
                          },
                        ),
                      ),
