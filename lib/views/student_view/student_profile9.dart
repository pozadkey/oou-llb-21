...
import 'package:legal_achievers/views/partial_views/student_details/student_details9.dart';
import 'package:legal_achievers/views/student_view/student_profile10.dart';
import 'package:legal_achievers/views/student_view/student_profile8.dart';

import '../about.dart';
import '../articles.dart';

class StudentProfile9 extends StatefulWidget {
  const StudentProfile9({Key? key}) : super(key: key);

  @override
  _StudentProfile9State createState() => _StudentProfile9State();
}

class _StudentProfile9State extends State<StudentProfile9> {
        ...
        children: [
          ListView.builder(
              ...
              itemBuilder: (context, index) {
                Students9 students9 = studentList9[index];
                studentList9.sort((a, b) => a.name.compareTo(b.name));
                return Container(
                  height: 100,
                  child: Padding(
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => StudentDetails9(
                                      students9: students9,
                                    )));
                          },
                        ),
            ...
            child: Row(
              ...
              children: [
                TextButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => StudentProfile8()));
                  },
                  child: Row(
                    children: [
