...
import 'package:legal_achievers/views/partial_views/student_details/student_details6.dart';
...
class StudentProfile6 extends StatefulWidget {
  const StudentProfile6({Key? key}) : super(key: key);

  @override
  _StudentProfile6State createState() => _StudentProfile6State();
}

class _StudentProfile6State extends State<StudentProfile6> {
      ...
      body: ListView(
        children: [
          ListView.builder(
              ...
              shrinkWrap: true,
              itemCount: studentList6.length,
              itemBuilder: (context, index) {
                Students6 students6 = studentList6[index];
                studentList6.sort((a, b) => a.name.compareTo(b.name));
                return Container(
                  height: 100,
                  child: Padding(
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => StudentDetails6(
                                      students6: students6,
                                    )));
                          },
                        ),
