...
import 'package:legal_achievers/views/partial_views/student_details/student_details5.dart';
import 'package:legal_achievers/views/student_view/student_profile4.dart';
import 'package:legal_achievers/views/student_view/student_profile6.dart';

import '../about.dart';
import '../articles.dart';

class StudentProfile5 extends StatefulWidget {
  const StudentProfile5({Key? key}) : super(key: key);

  @override
  _StudentProfile5State createState() => _StudentProfile5State();
}

class _StudentProfile5State extends State<StudentProfile5> {
        ...
        children: [
          ListView.builder(
              ...
              itemBuilder: (context, index) {
                Students5 students5 = studentList5[index];
                studentList5.sort((a, b) => a.name.compareTo(b.name));
                return Container(
                  height: 100,
                  child: Padding(
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => StudentDetails5(
                                      students5: students5,
                                    )));
                          },
                        ),
