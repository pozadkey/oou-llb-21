...
import 'package:legal_achievers/views/student_view/student_profile17.dart';
import 'package:legal_achievers/views/student_view/student_profile19.dart';

import '../../model/students/students_model_18.dart';
import '../about.dart';
import '../articles.dart';
import '../partial_views/student_details/student_details18.dart';

class StudentProfile18 extends StatefulWidget {
  const StudentProfile18({Key? key}) : super(key: key);

  @override
  _StudentProfile18State createState() => _StudentProfile18State();
}

class _StudentProfile18State extends State<StudentProfile18> {
      ...
      body: ListView(
        children: [
          ListView.builder(
              ...
              shrinkWrap: true,
              itemCount: studentList18.length,
              itemBuilder: (context, index) {
                Students18 students18 = studentList18[index];
                studentList18.sort((a, b) => a.name.compareTo(b.name));
                return Container(
                  height: 100,
                  child: Padding(
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => StudentDetails18(
            ...
            child: Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => StudentProfile19()));
                  },
                  child: Row(
                    children: [
                      Text(
