...
import 'package:legal_achievers/views/partial_views/student_details/student_details12.dart';
import 'package:legal_achievers/views/student_view/student_profile11.dart';
import 'package:legal_achievers/views/student_view/student_profile13.dart';

import '../about.dart';
import '../articles.dart';

class StudentProfile12 extends StatefulWidget {
  const StudentProfile12({Key? key}) : super(key: key);

  @override
  _StudentProfile12State createState() => _StudentProfile12State();
}

class _StudentProfile12State extends State<StudentProfile12> {
      ...
      body: ListView(
        children: [
          ListView.builder(
              ...
              shrinkWrap: true,
              itemCount: studentList12.length,
              itemBuilder: (context, index) {
                Students12 students12 = studentList12[index];
                studentList12.sort((a, b) => a.name.compareTo(b.name));
                return Container(
                  height: 100,
                  child: Padding(
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => StudentDetails12(
            ...
            child: Row(
              ...
              children: [
                TextButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => StudentProfile11()));
                  },
                  child: Row(
                    children: [
                ...
                TextButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => StudentProfile13()));
                  },
                  child: Row(
                    children: [
                      Text(
