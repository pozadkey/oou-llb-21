...
import '../partial_views/student_details/student_details23.dart';
import 'student_profile24.dart';

class StudentProfile23 extends StatefulWidget {
  const StudentProfile23({Key? key}) : super(key: key);

  @override
  _StudentProfile23State createState() => _StudentProfile23State();
}

class _StudentProfile23State extends State<StudentProfile23> {
      ...
      body: ListView(
        children: [
          ListView.builder(
              ...
              shrinkWrap: true,
              itemCount: studentList23.length,
              itemBuilder: (context, index) {
                Students23 students23 = studentList23[index];
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => StudentDetails23(
                                      students23: students23,
                                    )));
                          },
                        ),
                      ),
            ...
            child: Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => StudentProfile24()));
                  },
                  child: Row(
                    children: [
                      Text(
