...
import 'package:legal_achievers/views/partial_views/student_details/student_details14.dart';
...
class StudentProfile14 extends StatefulWidget {
  const StudentProfile14({Key? key}) : super(key: key);

  @override
  _StudentProfile14State createState() => _StudentProfile14State();
}

class _StudentProfile14State extends State<StudentProfile14> {
      ...
      body: ListView(
        children: [
          ListView.builder(
              ...
              shrinkWrap: true,
              itemCount: studentList14.length,
              itemBuilder: (context, index) {
                Students14 students14 = studentList14[index];
                studentList13.sort((a, b) => a.name.compareTo(b.name));
                return Container(
                  height: 100,
                  child: Padding(
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => StudentDetails14(
