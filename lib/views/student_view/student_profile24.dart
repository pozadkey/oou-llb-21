...
import '../partial_views/student_details/student_details24.dart';
import 'student_profile25.dart';

class StudentProfile24 extends StatefulWidget {
  const StudentProfile24({Key? key}) : super(key: key);

  @override
  _StudentProfile24State createState() => _StudentProfile24State();
}

class _StudentProfile24State extends State<StudentProfile24> {
      ...
      body: ListView(
        children: [
          ListView.builder(
              ...
              shrinkWrap: true,
              itemCount: studentList24.length,
              itemBuilder: (context, index) {
                Students24 students24 = studentList24[index];
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => StudentDetails24(
                                      students24: students24,
                                    )));
                          },
                        ),
                      ),
