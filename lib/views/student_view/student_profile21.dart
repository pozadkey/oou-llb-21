...
import 'package:legal_achievers/views/student_view/student_profile20.dart';
import 'package:legal_achievers/views/student_view/student_profile22.dart';

import '../../model/students/students_model_21.dart';
import '../about.dart';
import '../articles.dart';
import '../partial_views/student_details/student_details21.dart';

class StudentProfile21 extends StatefulWidget {
  const StudentProfile21({Key? key}) : super(key: key);

  @override
  _StudentProfile21State createState() => _StudentProfile21State();
}

class _StudentProfile21State extends State<StudentProfile21> {
        ...
        children: [
          ListView.builder(
              ...
              itemBuilder: (context, index) {
                Students21 students21 = studentList21[index];
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => StudentDetails21(
                                      students21: students21,
                                    )));
                          },
                        ),
                      ),
            ...
            child: Row(
              ...
              children: [
                TextButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => StudentProfile20()));
                  },
                  child: Row(
                    children: [
                ...
                TextButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => StudentProfile22()));
                  },
                  child: Row(
                    children: [
                      Text(
