...
import '../partial_views/student_details/student_details20.dart';

class StudentProfile20 extends StatefulWidget {
  const StudentProfile20({Key? key}) : super(key: key);

  @override
  _StudentProfile20State createState() => _StudentProfile20State();
}

class _StudentProfile20State extends State<StudentProfile20> {
        ...
        children: [
          ListView.builder(
              ...
              itemBuilder: (context, index) {
                Students20 students20 = studentList20[index];
                studentList20.sort((a, b) => a.name.compareTo(b.name));
                return Container(
                  height: 100,
                  child: Padding(
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => StudentDetails20(
