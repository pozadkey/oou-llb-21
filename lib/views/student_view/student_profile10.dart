// ignore_for_file: prefer_const_constructors, avoid_returning_null_for_void, sized_box_for_whitespace, curly_braces_in_flow_control_structures, prefer_const_literals_to_create_immutables
...
class StudentProfile10 extends StatefulWidget {
  const StudentProfile10({Key? key}) : super(key: key);

  @override
  _StudentProfile10State createState() => _StudentProfile10State();
}

class _StudentProfile10State extends State<StudentProfile10> {
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => StudentDetails10(
