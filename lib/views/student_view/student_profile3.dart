...
class StudentProfile3 extends StatefulWidget {
  const StudentProfile3({Key? key}) : super(key: key);

  @override
  _StudentProfile3State createState() => _StudentProfile3State();
}

class _StudentProfile3State extends State<StudentProfile3> {
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => StudentDetails3(
                                      students3: students3,
                                    )));
                          },
                        ),
