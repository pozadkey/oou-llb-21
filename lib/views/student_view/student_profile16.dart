...
import 'package:legal_achievers/views/partial_views/student_details/student_details16.dart';
...
class StudentProfile16 extends StatefulWidget {
  const StudentProfile16({Key? key}) : super(key: key);

  @override
  _StudentProfile16State createState() => _StudentProfile16State();
}

class _StudentProfile16State extends State<StudentProfile16> {
      ...
      body: ListView(
        children: [
          ListView.builder(
              ...
              shrinkWrap: true,
              itemCount: studentList16.length,
              itemBuilder: (context, index) {
                Students16 students16 = studentList16[index];
                studentList16.sort((a, b) => a.name.compareTo(b.name));
                return Container(
                  height: 100,
                  child: Padding(
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => StudentDetails16(
