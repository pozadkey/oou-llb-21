...
import 'package:legal_achievers/views/partial_views/student_details/student_details13.dart';
...
class StudentProfile13 extends StatefulWidget {
  const StudentProfile13({Key? key}) : super(key: key);

  @override
  _StudentProfile13State createState() => _StudentProfile13State();
}

class _StudentProfile13State extends State<StudentProfile13> {
      ...
      body: ListView(
        children: [
          ListView.builder(
              ...
              shrinkWrap: true,
              itemCount: studentList13.length,
              itemBuilder: (context, index) {
                Students13 students13 = studentList13[index];
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => StudentDetails13(
