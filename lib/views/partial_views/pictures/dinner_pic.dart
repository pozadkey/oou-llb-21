...
import 'package:legal_achievers/model/gallery_model/dinner_model.dart';
import 'package:url_launcher/url_launcher.dart';

import 'fullscreen/fullscreen.dart';

class DinnerPic extends StatelessWidget {
  const DinnerPic({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    _launchURLBrowser() async {
      const url =
          'https://drive.google.com/folderview?id=1YN3HasxU4dm_ikfPT5HwFbR5bof43NlB';
      ...
      appBar: PreferredSize(
        ...
        child: SafeArea(
          child: AppBar(
            elevation: 0,
            centerTitle: true,
            title: Text('Dinner', style: _headerfonts),
          ),
        ),
      ),
              ...
              children: [
                GridView.builder(
                    ...
                    itemBuilder: (BuildContext ctx, index) {
                      Dinner groupPics = dinnerList[index];
                      return SizedBox(
                        height: 200,
